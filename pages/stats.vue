<template>
  <div class="dark:bg-black dark:text-white">
    ...
    <div class="min-h-screen bg-white dark:bg-black text-black dark:text-white">
      <div class="px-4 lg:px-8 py-16 lg:py-32">
        <div class="max-w-4xl mx-auto space-y-32">
          <!-- Title -->
          <header class="space-y-4">
            <div class="space-y-1">
              <p class="text-xs font-mono uppercase tracking-wider text-gray-500 dark:text-gray-400">Photography
                Statistics</p>
          ...
          <div v-else-if="data" class="space-y-32">
            ...
            <section class="grid grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16">
              <div v-for="stat in overviewStats" :key="stat.label" class="space-y-2">
                <p class="text-5xl lg:text-6xl font-fjalla tracking-tight tabular-nums">{{ stat.value }}</p>
            ...
            <section class="space-y-8">
              ...
              <div class="grid grid-cols-2 gap-x-12">
                <div class="space-y-2">
                  <p class="text-5xl lg:text-6xl font-fjalla tracking-tight tabular-nums">{{ data.currentStreak.count }}
                  </p>
                ...
                <div class="space-y-2">
                  <p class="text-5xl lg:text-6xl font-fjalla tracking-tight tabular-nums">{{ data.longestStreak.count }}
                  </p>
              ...
              <div class="space-y-6">
                <div v-for="camera in data.gearStats.cameras" :key="camera.name"
                  ...
                  <div class="flex items-baseline gap-6">
                    <span class="text-sm font-mono tabular-nums text-gray-500">{{ camera.count.toString().padStart(4,
                      '0') }}</span>
